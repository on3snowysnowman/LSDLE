...
public:
     ...
     * @param m Target Menu
     */
    static void register_menu(Menu* m);
     ...
     */
    static void activate_menu(std::string menu_id);
     ...
     * @param menu_id Id of the target Menu
     */
    static void deactivate_menu(std::string menu_id);
     ...
     * @param m Target Menu
     */
    static void deactivate_menu(Menu* m);
     ...
     */
    static Menu* get_menu(std::string menu_id);
...
private:
    ...
    //  * MenuHandler to read.
    //  */
    // static std::queue<InstructionSequence> instruction_queue;
     ...
     * as keys.
     */
    static std::unordered_map<std::string, Menu*> registered_menus;
    ...
    //  */
    // static void process_instruction(InstructionSequence& i);
    ...
    //  */
    // static std::string get_next_instruction(InstructionSequence& i);
};